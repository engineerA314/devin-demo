        ...
        <div className="page">
          <div className="page-heading">
            ...
            <div className="status-pill">
              ...
              {config?.mode === 'embedded' ? 'Superset connected' : 'Superset connection required'}
            </div>
          </div>
          ...
          <section className="analytics-card" aria-labelledby="dashboard-title">
            ...
            {configError && (
              <div className="controller-error" role="status">
                Unable to reach the incident controller: {configError}
              </div>
            )}
          </section>
      ...
      <header className="product-header">
        ...
        <div className="product-header__actions">
          ...
          <a className="product-utility-link" href="/incident-simulator">
            <FlaskConical size={15} /> Open incident simulator
          </a>
